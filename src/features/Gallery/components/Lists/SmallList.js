    ...
    return (
        <View dayObjects={dayObjects}>
            <View style={styles.headerContainer}>
                <Text style={{fontFamily:"Sora_600SemiBold", fontSize: 16, color: text1()}}>This week</Text>
            ...
            <ScrollView dayObjects={dayObjects} horizontal={true} showsHorizontalScrollIndicator={false} contentContainerStyle={{paddingBottom: 20, marginLeft: -5, overflow: 'visible'}}>
